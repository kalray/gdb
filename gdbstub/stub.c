...
static bool printf_packet (struct gdbstub *stub, char *fmt, ...) __attribute__ ((format (printf, 2, 3)));
static bool nprintf_packet (struct gdbstub *stub, int size, char *fmt, ...) __attribute__ ((format (printf, 3, 4)));
...
int
gdbstub_listen (int port, int port_end, struct gdbstub *stub)
{
...
int
gdbstub_accept (struct gdbstub *stub)
{
...
static void
notify_callback (debug_agent_t *da, int vehicle, void *notify_data)
{
...
static int
compare_da_ids (const void *e1, const void *e2)
{
...
void
gdbstub_rt_add_agent (struct gdbstub *stub, debug_agent_t *da)
{
...
void
gdbstub_start (struct gdbstub *stub, bool thread)
{
  int i, j;
...
const char *
get_error (struct gdbstub *stub)
{
  return stub->error;
}

static bool
get_message (struct gdbstub *stub)
{
  int len;
...
static bool
send_answer (struct gdbstub *stub)
{
...
static void
prepare_to_answer (struct gdbstub *stub)
{
  stub->data_len = 1;
  stub->header = '$';
}
...
static bool
printf_packet (struct gdbstub *stub, char *fmt, ...)
{
  int len;
  va_list ap;
...
static bool
nprintf_packet (struct gdbstub *stub, int size, char *fmt, ...)
{
  int len;
  va_list ap;
...
static int
send_err (struct gdbstub *stub, int quiet)
{
  if (!quiet)
...
static int
send_unsupported (struct gdbstub *stub)
{
  stub->data_len = 1;
  stub->header = '$';
  return send_answer (stub);
...
static bool
parse_thread_id (struct gdbstub *stub, struct context *ctxt, char *id, char **end)
{
  char *endptr;
...
static void
set_exec_context (struct gdbstub *stub, struct context ctxt)
{
...
static void
set_data_context (struct gdbstub *stub, struct context ctxt)
{
...
handle_g (struct gdbstub *stub)
{
   ...
   */
  debug_agent_read_registers (D_CONTEXT, stub->all_reg_ids, buf, stub->nbregs);
...
static bool
handle_qSupported (struct gdbstub *stub)
{
  prepare_to_answer (stub);
...
static void
update_registers_xml (struct gdbstub *stub, struct agent *ag)
{
...
static bool
handle_qXfer_features_read (struct gdbstub *stub)
{
  char *endptr;
  int length, offset;
  struct agent *ag;
...
static bool
handle_qXfer_osdata_read (struct gdbstub *stub)
{
  char *endptr;
  int length, offset;
...
static bool
handle_qXfer_threads_read (struct gdbstub *stub)
{
  char *endptr;
  int length, offset;
...
static bool
kalray_set_break_on_spawn (struct gdbstub *stub)
{
  struct context ctxt;
  struct agent *ag;
  int v;
...
static bool
kalray_set_stop_all (struct gdbstub *stub)
{
  struct context ctxt;
  int v;
...
static unsigned int
unescape (char* src, unsigned int src_len)
{
  char *c;
...
static bool
append_stop_packet (struct gdbstub *stub, struct stopped_context *c,
...
static bool
handle_threadinfo (struct gdbstub *stub)
{
  int i, nbvehicles;
...
static bool
handle_qGetTLSAddr (struct gdbstub *stub)
{
  unsigned int v1, v2;
  char *endptr;
  struct context ctxt;
...
static bool
handle_question (struct gdbstub *stub)
{
  prepare_to_answer (stub);
...
static errcode_t
run_in_thread (struct gdbstub *stub, int agent, int vehicle,
  errcode_t (*run_cmd) (debug_agent_t *, int))
{
...
static errcode_t
debug_agent_interrupt (debug_agent_t *da, int vehicle)
{
  return debug_agent_stop (da, vehicle, EXEC_SIGNALED, 2);
}

static bool
context_matches (struct context *c1, struct context *c2)
{
...
static bool
handle_vCont_run (struct gdbstub *stub, errcode_t (*run_cmd) (debug_agent_t *, int))
{
...
static bool
handle_vKill (struct gdbstub *stub)
{
  /* FIXME */
  stub->exited = 0;
  stub->exit_value = 0;
...
static bool
handle_vStopped (struct gdbstub *stub)
{
...
static bool
add_stopped_context (struct gdbstub *stub, int agent, int vehicle)
{
  struct stopped_context *ctxt;
...
static bool
handle_vAttach (struct gdbstub *stub)
{
  char *endptr;
...
bool
handle_command (struct gdbstub *stub)
{
  if (!get_message (stub))
    return false;
...
void
gdbstub_notify_context_stop (struct gdbstub *stub, int agent, int vehicle)
{
...
void
gdbstub_set_skip_exit_when_stub_exited (struct gdbstub *stub, bool v)
{
 ...
 */
static void
my_exit (struct gdbstub *stub, int val)
{
  if (stub->exited)
  {
...
void
gdbstub_join (struct gdbstub *stub, pthread_t cthread)
{
  if (cthread == 0)
...
control_thread (void *void_stub)
{
  ...
  while (true)
  {
    ...
    if (pollfds[0].revents & (POLLERR | POLLHUP | POLLNVAL) || pollfds[1].revents & (POLLERR | POLLHUP | POLLNVAL))
    {
      perror ("poll2");
      EXIT_THREAD (stub, -1);
    }
