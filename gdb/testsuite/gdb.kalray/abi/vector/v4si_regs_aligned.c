...
int check_args_are_correct (v4si a01, v4si a23,
			    int a4, int a5,
			    v4si a67, v4si a89, v4si a1011,
			    int s0, int s1);

int check_args_are_correct_user (v4si a01, v4si a23,
				 int a4, int a5,
				 v4si a67, v4si a89, v4si a1011,
				 int s0, int s1)
{
...
int main (int argc, char **argv){
  ...
  return !check_args_are_correct (v01, v23, 4, 5, v67, v89,
				  v1011, 12, 13);
