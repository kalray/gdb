...
int check_args_are_correct (struct does_not_fit_in_a_reg s0123, int a4, int a5, int a6);

int check_args_are_correct_user (struct does_not_fit_in_a_reg s0123, int a4, int a5, int a6)
  {
...
int main (int argc, char **argv){
  struct does_not_fit_in_a_reg s0123 = { 0xCC, 0xDD, 0xEE, 0xFF, 0xdeadbeef,
