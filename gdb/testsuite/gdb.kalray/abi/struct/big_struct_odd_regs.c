...
int check_args_are_correct (int a0, struct does_not_fit_in_a_reg s1234, int a5, int a6);

int check_args_are_correct_user (int a0, struct does_not_fit_in_a_reg s1234, int a5, int a6)
{
  return a0 == 0
    && s1234.f0_0 == (char) 0xCC
    && s1234.f1_0 == (char)  0xDD
    && s1234.f2_0 == (char)  0xEE
    && s1234.f3_0 == (char)  0xFF
    ...
    && s1234.l8_4 == (long long) 0x4444444444444444ULL
    && a5 == 2
    && a6 == 3;
}
