...
int check_args_are_correct_user (struct correctly_aligned_int128 a0123456789,
				 int argument10, int argument11)
{
  return a0123456789.reg0_0 == 0
    && a0123456789.reg0_0 == 0
    && a0123456789.reg1_0 == 1
    && a0123456789.reg1_1 == 1
    && a0123456789.reg2 == 2
    && a0123456789.reg3 == 3
    && a0123456789.reg45 == ((unsigned __int128)0xdeadbeef12345678ULL) SHIFT_64 + 0xCDEFAA9955555555ULL
    && a0123456789.reg67 == ((unsigned __int128)0xdeaddead12345678ULL) SHIFT_64 + 0xBCDEFBB888888888ULL
    && a0123456789.reg89 == ((unsigned __int128)0xbeefbeef12345678ULL) SHIFT_64 + 0xBCDEFCC777777777ULL;
}

int main (int argc, char **argv) {
  struct correctly_aligned_int128 mystruct = {
					      0,0,1,1,2,3,
					      ((unsigned __int128)0xdeadbeef12345678ULL) SHIFT_64 + 0xCDEFAA9955555555ULL,
					      ((unsigned __int128)0xdeaddead12345678ULL) SHIFT_64 + 0xBCDEFBB888888888ULL,
					      ((unsigned __int128)0xbeefbeef12345678ULL) SHIFT_64 + 0xBCDEFCC777777777ULL
  };
