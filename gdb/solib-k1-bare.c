...
struct target_so_ops k1_bare_solib_ops;
...
static const struct program_space_data *k1_bare_solib_pspace_data;

static void
k1_bare_solib_pspace_data_cleanup (struct program_space *pspace, void *arg)
{
  xfree (arg);
}

/* Get the current K1 data.  If none is found yet, add it now.  This
   function always returns a valid object */
static struct k1_bare_solib_info *
k1_bare_solib_get_info (void)
{
...
void
k1_bare_solib_load_debug_info (void)
{
...
{
  struct k1_bare_solib_info *info = k1_bare_solib_get_info ();
...
static void
k1_bare_solib_solib_create_inferior_hook (int from_tty)
{
  k1_bare_solib_clear_solib ();
  k1_bare_solib_load_debug_info ();
}

/* No special symbol handling.  */
static void
k1_bare_solib_special_symbol_handling (void)
{
}
...
/*  Not used */
static int
k1_bare_solib_open_symbol_file_object (void *from_ttyp)
{
  return 0;
}

extern initialize_file_ftype _initialize_k1_bare_solib;
