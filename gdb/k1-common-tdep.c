...
static void
k1_frame_this_id (struct frame_info *this_frame, void **this_prologue_cache,
...
const struct frame_unwind k1_frame_unwind = {NORMAL_FRAME,
...
CORE_ADDR
k1_push_dummy_call (struct gdbarch *gdbarch, struct value *function,
...
static void
k1_store_return_value (struct gdbarch *gdbarch, struct type *type,
...
static void
k1_extract_return_value (struct gdbarch *gdbarch, struct type *type,
