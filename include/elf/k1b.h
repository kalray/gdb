...
START_RELOC_NUMBERS (elf_k1_reloc_type)
    ...
    RELOC_NUMBER (R_K1_32_PCREL,                            5)
    RELOC_NUMBER (R_K1_LO10,                                6)
    RELOC_NUMBER (R_K1_HI22,                                7)
    RELOC_NUMBER (R_K1_GPREL_LO10,                          8)
    RELOC_NUMBER (R_K1_GPREL_HI22,                          9)
    RELOC_NUMBER (R_K1_TPREL_LO10,                         10)
    RELOC_NUMBER (R_K1_TPREL_HI22,                         11)
    RELOC_NUMBER (R_K1_TPREL_32,                           12)
    RELOC_NUMBER (R_K1_GOTOFF_LO10,                        13)
    RELOC_NUMBER (R_K1_GOTOFF_HI22,                        14)
    RELOC_NUMBER (R_K1_GOT_LO10,                           15)
    RELOC_NUMBER (R_K1_GOT_HI22,                           16)
    RELOC_NUMBER (R_K1_GLOB_DAT,                           17)
    RELOC_NUMBER (R_K1_PLT_LO10,                           18)
    RELOC_NUMBER (R_K1_PLT_HI22,                           19)
    RELOC_NUMBER (R_K1_FUNCDESC,                           20)
    RELOC_NUMBER (R_K1_FUNCDESC_GOT_LO10,                  21)
    RELOC_NUMBER (R_K1_FUNCDESC_GOT_HI22,                  22)
    RELOC_NUMBER (R_K1_FUNCDESC_GOTOFF_LO10,               23)
    RELOC_NUMBER (R_K1_FUNCDESC_GOTOFF_HI22,               24)
    RELOC_NUMBER (R_K1_FUNCDESC_VALUE,                     25)
    RELOC_NUMBER (R_K1_GOTOFF,                             26)
    RELOC_NUMBER (R_K1_GOT,                                27)
    RELOC_NUMBER (R_K1_10_GPREL,                           28)
    RELOC_NUMBER (R_K1_16_GPREL,                           29)
    RELOC_NUMBER (R_K1_COPY,                               30)
    RELOC_NUMBER (R_K1_JMP_SLOT,                           31)
    RELOC_NUMBER (R_K1_RELATIVE,                           32)
    RELOC_NUMBER (R_K1_ELO10,                              33)
    RELOC_NUMBER (R_K1_HI27,                               34)
    RELOC_NUMBER (R_K1_EXTEND6,                            35)
    RELOC_NUMBER (R_K1_64,                                 36)
    RELOC_NUMBER (R_K1_TPREL64_ELO10,                      37)
    RELOC_NUMBER (R_K1_TPREL64_HI27,                       38)
    RELOC_NUMBER (R_K1_TPREL64_EXTEND6,                    39)
    RELOC_NUMBER (R_K1_TPREL64_64,                         40)
    RELOC_NUMBER (R_K1_GOTOFF64,                           41)
    RELOC_NUMBER (R_K1_GOTOFF64_LO10,                      42)
    RELOC_NUMBER (R_K1_GOTOFF64_HI27,                      43)
    RELOC_NUMBER (R_K1_GOTOFF64_EXTEND6,                   44)
    RELOC_NUMBER (R_K1_GOT64_LO10,                         45)
    RELOC_NUMBER (R_K1_GOT64_HI27,                         46)
    RELOC_NUMBER (R_K1_GOT64_EXTEND6,                      47)
    RELOC_NUMBER (R_K1_GOT64,                              48)
    RELOC_NUMBER (R_K1_GLOB_DAT64,                         49)
    RELOC_NUMBER (R_K1_PLT64_LO10,                         50)
    RELOC_NUMBER (R_K1_PLT64_HI27,                         51)
    RELOC_NUMBER (R_K1_PLT64_EXTEND6,                      52)
    RELOC_NUMBER (R_K1_S37_HI27,                           53)
    RELOC_NUMBER (R_K1_S37_LO10,                           54)
    RELOC_NUMBER (R_K1_JMP_SLOT64,                         55)
