...
START_RELOC_NUMBERS (elf_k1_reloc_type)
    ...
    RELOC_NUMBER (R_K1_TPREL_S37_LO10,                         9)
    RELOC_NUMBER (R_K1_TPREL_S37_UP27,                        10)
    RELOC_NUMBER (R_K1_TPREL_32,                              11)
    RELOC_NUMBER (R_K1_GOTOFF_LO10,                           12)
    RELOC_NUMBER (R_K1_GOTOFF_UP27,                           13)
    RELOC_NUMBER (R_K1_GOT_LO10,                              14)
    RELOC_NUMBER (R_K1_GOT_UP27,                              15)
    RELOC_NUMBER (R_K1_GLOB_DAT,                              16)
    RELOC_NUMBER (R_K1_PLT_LO10,                              17)
    RELOC_NUMBER (R_K1_PLT_UP27,                              18)
    ...
    RELOC_NUMBER (R_K1_TPREL64_LO10,                          28)
    RELOC_NUMBER (R_K1_TPREL64_UP27,                          29)
    RELOC_NUMBER (R_K1_TPREL64_EX6,                           30)
    RELOC_NUMBER (R_K1_TPREL64_64,                            31)
    RELOC_NUMBER (R_K1_GOTOFF64,                              32)
    RELOC_NUMBER (R_K1_GOTOFF64_LO10,                         33)
    RELOC_NUMBER (R_K1_GOTOFF64_UP27,                         34)
    RELOC_NUMBER (R_K1_GOTOFF64_EX6,                          35)
    RELOC_NUMBER (R_K1_GOT64_LO10,                            36)
    RELOC_NUMBER (R_K1_GOT64_UP27,                            37)
    RELOC_NUMBER (R_K1_GOT64_EX6,                             38)
    RELOC_NUMBER (R_K1_GOT64,                                 39)
    RELOC_NUMBER (R_K1_GLOB_DAT64,                            40)
    RELOC_NUMBER (R_K1_PLT64_LO10,                            41)
    RELOC_NUMBER (R_K1_PLT64_UP27,                            42)
    RELOC_NUMBER (R_K1_PLT64_EX6,                             43)
